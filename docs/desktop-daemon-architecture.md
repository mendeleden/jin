...
- Desktop distribution treats Windows x64 as a parity target. The Windows
  transport must keep auth, strict loopback binding, collision handling,
  diagnostics, packaging/update, and security review checks in place.
